...
%Company{
  ...
  logo:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Warner_Bros_logo.svg/800px-Warner_Bros_logo.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/en/c/c8/Village_roadshow_pictures_logo.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/en/3/37/Silver_pictures_2.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/pt/f/fc/Paramountlogotipo.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/pt/e/e0/20th_Century_Fox_logo.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/en/4/42/Lightstorm_Entertainment_logo.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Lucasfilm_logo.svg/800px-Lucasfilm_logo.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/en/f/fb/Castle_Rock_Entertainment_logo.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/d/d7/Legendary_Pictures_logo.svg/1024px-Legendary_Pictures_logo.svg.png"
}
|> Repo.insert!()

%Company{
  id: 12,
  name: "Syncopy Films Inc.",
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/en/6/6a/SyncopyInc._logo.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/DreamWorks_Pictures.svg/1920px-DreamWorks_Pictures.svg.png"
}
|> Repo.insert!()

%Company{
  id: 14,
  name: "Reliance Entertainment Pvt Ltd",
  country: "India",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/b/bc/Relianceent.jpg/1280px-Relianceent.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/5/5c/Amblin_Entertainment_logo.svg/1024px-Amblin_Entertainment_logo.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/a/a1/Universal_Studios.svg/800px-Universal_Studios.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/New_Line_Cinema.svg/800px-New_Line_Cinema.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "New Zealand",
  logo:
    "https://vignette.wikia.nocookie.net/wingnut-films/images/d/d7/WingNut_Films_Logo.gif/revision/latest?cb=20181106234758"
}
|> Repo.insert!()

%Company{
  id: 19,
  name: "A Band Apart Films",
  country: "United States",
  logo: "https://upload.wikimedia.org/wikipedia/en/4/4c/A_Band_Apart_logo.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/2/28/Columbia_Pictures_Logo.svg/1920px-Columbia_Pictures_Logo.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/2/20/Walt_Disney_Pictures_Logo_2011.svg/1280px-Walt_Disney_Pictures_Logo_2011.svg.png"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo: "https://gizmodo.uol.com.br/wp-content/blogs.dir/8/files/2013/09/pixar.jpg"
}
|> Repo.insert!()
...
%Company{
  ...
  country: "United States",
  logo:
    "https://upload.wikimedia.org/wikipedia/en/thumb/c/c8/Walt_Disney_Animation_Studios_logo.svg/800px-Walt_Disney_Animation_Studios_logo.svg.png"
}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Agent Smith", movie_id: 1, actor_id: 4}
|> Repo.insert!()
...
%Character{protagonist: false, character: "The Oracle", movie_id: 1, actor_id: 21}
|> Repo.insert!()

# Titanic
%Character{protagonist: true, character: "Jack Dawson", movie_id: 2, actor_id: 9}
|> Repo.insert!()

%Character{protagonist: true, character: "Rose Dewitt Bukater", movie_id: 2, actor_id: 10}
|> Repo.insert!()

%Character{protagonist: false, character: "Cal Hockley", movie_id: 2, actor_id: 11}
|> Repo.insert!()

%Character{protagonist: false, character: "Molly Brown", movie_id: 2, actor_id: 12}
|> Repo.insert!()

%Character{protagonist: false, character: "Ruth Dewitt Bukater", movie_id: 2, actor_id: 13}
|> Repo.insert!()

%Character{protagonist: false, character: "Old Rose", movie_id: 2, actor_id: 14} |> Repo.insert!()

%Character{protagonist: false, character: "Brock Lovett", movie_id: 2, actor_id: 15}
|> Repo.insert!()

%Character{protagonist: false, character: "Captain Smith", movie_id: 2, actor_id: 16}
|> Repo.insert!()

%Character{protagonist: false, character: "Spicer Lovejoy", movie_id: 2, actor_id: 17}
|> Repo.insert!()

%Character{protagonist: false, character: "Thomas Andrews", movie_id: 2, actor_id: 18}
|> Repo.insert!()

%Character{protagonist: false, character: "Bruce Ismay", movie_id: 2, actor_id: 19}
|> Repo.insert!()

%Character{protagonist: false, character: "Lizzy Calvert", movie_id: 2, actor_id: 20}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Agent Smith", movie_id: 3, actor_id: 4}
|> Repo.insert!()

%Character{protagonist: false, character: "The Oracle", movie_id: 3, actor_id: 21}
|> Repo.insert!()

# Star Wars: Episode IV - A New Hope
%Character{protagonist: true, character: "Luke Skywalker", movie_id: 4, actor_id: 22}
|> Repo.insert!()

%Character{protagonist: true, character: "Han Solo", movie_id: 4, actor_id: 23} |> Repo.insert!()

%Character{protagonist: true, character: "Princess Leia Organa", movie_id: 4, actor_id: 24}
|> Repo.insert!()

%Character{protagonist: false, character: "Grand Moff Tarkin", movie_id: 4, actor_id: 25}
|> Repo.insert!()

%Character{protagonist: false, character: "Ben Obi-Wan Kenobi", movie_id: 4, actor_id: 26}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Chewbacca", movie_id: 4, actor_id: 29}
|> Repo.insert!()

%Character{protagonist: false, character: "Darth Vader", movie_id: 4, actor_id: 30}
|> Repo.insert!()

# Star Wars: Episode V - The Empire Strikes Back
%Character{protagonist: true, character: "Luke Skywalker", movie_id: 5, actor_id: 22}
|> Repo.insert!()

%Character{protagonist: true, character: "Han Solo", movie_id: 5, actor_id: 23} |> Repo.insert!()

%Character{protagonist: true, character: "Princess Leia Organa", movie_id: 5, actor_id: 24}
|> Repo.insert!()

%Character{protagonist: false, character: "Ben Obi-Wan Kenobi", movie_id: 5, actor_id: 26}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Chewbacca", movie_id: 5, actor_id: 29}
|> Repo.insert!()

%Character{protagonist: false, character: "Darth Vader", movie_id: 5, actor_id: 30}
|> Repo.insert!()

%Character{protagonist: false, character: "Lando Calrissian", movie_id: 5, actor_id: 31}
|> Repo.insert!()

%Character{protagonist: false, character: "Yoda", movie_id: 5, actor_id: 32} |> Repo.insert!()

%Character{protagonist: false, character: "Boba Fett", movie_id: 5, actor_id: 33}
|> Repo.insert!()

# Star Wars: Episode VI - Return of the Jedi
%Character{protagonist: true, character: "Luke Skywalker", movie_id: 6, actor_id: 22}
|> Repo.insert!()

%Character{protagonist: true, character: "Han Solo", movie_id: 6, actor_id: 23} |> Repo.insert!()

%Character{protagonist: true, character: "Princess Leia Organa", movie_id: 6, actor_id: 24}
|> Repo.insert!()

%Character{protagonist: false, character: "Ben Obi-Wan Kenobi", movie_id: 6, actor_id: 26}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Chewbacca", movie_id: 6, actor_id: 29}
|> Repo.insert!()

%Character{protagonist: false, character: "Darth Vader", movie_id: 6, actor_id: 30}
|> Repo.insert!()

%Character{protagonist: false, character: "Lando Calrissian", movie_id: 6, actor_id: 31}
|> Repo.insert!()

%Character{protagonist: false, character: "Yoda", movie_id: 6, actor_id: 32} |> Repo.insert!()

%Character{protagonist: false, character: "Boba Fett", movie_id: 6, actor_id: 33}
|> Repo.insert!()

%Character{protagonist: false, character: "The Emperor", movie_id: 6, actor_id: 34}
|> Repo.insert!()

# I am Legend
%Character{protagonist: true, character: "Robert Neville", movie_id: 7, actor_id: 35}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Zoe Neville", movie_id: 7, actor_id: 38}
|> Repo.insert!()

%Character{protagonist: false, character: "Marley Neville", movie_id: 7, actor_id: 39}
|> Repo.insert!()

%Character{protagonist: false, character: "Mike - Military Escort", movie_id: 7, actor_id: 40}
|> Repo.insert!()

%Character{protagonist: false, character: "TV Personality", movie_id: 7, actor_id: 41}
|> Repo.insert!()

# The Godfather
%Character{protagonist: true, character: "Don Vito Corleone", movie_id: 8, actor_id: 42}
|> Repo.insert!()

%Character{protagonist: true, character: "Michael Corleone", movie_id: 8, actor_id: 43}
|> Repo.insert!()

%Character{protagonist: true, character: "Sonny Corleone", movie_id: 8, actor_id: 44}
|> Repo.insert!()

%Character{protagonist: false, character: "Clemenza", movie_id: 8, actor_id: 45} |> Repo.insert!()

%Character{protagonist: false, character: "Tom Hagen", movie_id: 8, actor_id: 46}
|> Repo.insert!()

%Character{protagonist: false, character: "Capt. McCluskey", movie_id: 8, actor_id: 47}
|> Repo.insert!()

%Character{protagonist: false, character: "Jack Woltz", movie_id: 8, actor_id: 48}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Kay Adams", movie_id: 8, actor_id: 51}
|> Repo.insert!()
...
# The Green Mile
%Character{protagonist: true, character: "Paul Edgecomb", movie_id: 9, actor_id: 57}
|> Repo.insert!()

%Character{protagonist: true, character: "Brutus 'Brutal' Howell", movie_id: 9, actor_id: 58}
|> Repo.insert!()

%Character{protagonist: true, character: "Jan Edgecomb", movie_id: 9, actor_id: 59}
|> Repo.insert!()

%Character{protagonist: true, character: "John Coffey", movie_id: 9, actor_id: 60}
|> Repo.insert!()

%Character{protagonist: false, character: "Warden Hal Moores", movie_id: 9, actor_id: 61}
|> Repo.insert!()

%Character{protagonist: false, character: "Eduard Delacroix", movie_id: 9, actor_id: 62}
|> Repo.insert!()

%Character{protagonist: false, character: "Arlen Bitterbuck", movie_id: 9, actor_id: 63}
|> Repo.insert!()

%Character{protagonist: false, character: "Percy Wetmore", movie_id: 9, actor_id: 64}
|> Repo.insert!()

%Character{protagonist: false, character: "'Wild Bill' Wharton", movie_id: 9, actor_id: 65}
|> Repo.insert!()

%Character{protagonist: false, character: "Dean Stanton", movie_id: 9, actor_id: 66}
|> Repo.insert!()

%Character{protagonist: false, character: "Harry Terwilliger", movie_id: 9, actor_id: 67}
|> Repo.insert!()

%Character{protagonist: false, character: "Melinda Moores", movie_id: 9, actor_id: 68}
|> Repo.insert!()

%Character{protagonist: false, character: "Toot-Toot", movie_id: 9, actor_id: 69}
|> Repo.insert!()

%Character{protagonist: false, character: "Old Paul Edgecomb", movie_id: 9, actor_id: 70}
|> Repo.insert!()

%Character{protagonist: false, character: "Elaine Connelly", movie_id: 9, actor_id: 71}
|> Repo.insert!()

# The Dark Knight
%Character{protagonist: true, character: "Bruce Wayne", movie_id: 10, actor_id: 72}
|> Repo.insert!()

%Character{protagonist: false, character: "Joker", movie_id: 10, actor_id: 73} |> Repo.insert!()

%Character{protagonist: false, character: "Harvey Dent", movie_id: 10, actor_id: 74}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Lucius Fox", movie_id: 10, actor_id: 78}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Scarecrow", movie_id: 10, actor_id: 81}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Mike Engel", movie_id: 10, actor_id: 86}
|> Repo.insert!()

# The Help
%Character{protagonist: true, character: "Skeeter Phelan", movie_id: 11, actor_id: 87}
|> Repo.insert!()

%Character{protagonist: false, character: "Aibileen Clark", movie_id: 11, actor_id: 88}
|> Repo.insert!()

%Character{protagonist: false, character: "Hilly Holbrook", movie_id: 11, actor_id: 89}
|> Repo.insert!()

%Character{protagonist: false, character: "Minny Jackson", movie_id: 11, actor_id: 90}
|> Repo.insert!()

%Character{protagonist: false, character: "Celia Foote", movie_id: 11, actor_id: 91}
|> Repo.insert!()

%Character{protagonist: false, character: "Elizabeth Leefolt", movie_id: 11, actor_id: 92}
|> Repo.insert!()

%Character{protagonist: false, character: "Charlotte Phelan", movie_id: 11, actor_id: 93}
|> Repo.insert!()

%Character{protagonist: false, character: "Jolene French", movie_id: 11, actor_id: 94}
|> Repo.insert!()

%Character{protagonist: false, character: "Mae Mobley", movie_id: 11, actor_id: 95}
|> Repo.insert!()

%Character{protagonist: false, character: "Mae Mobley", movie_id: 11, actor_id: 96}
|> Repo.insert!()

%Character{protagonist: false, character: "Stuart Whitworth", movie_id: 11, actor_id: 97}
|> Repo.insert!()

%Character{protagonist: false, character: "Constantine Jefferson", movie_id: 11, actor_id: 98}
|> Repo.insert!()

%Character{protagonist: false, character: "Johnny Foote", movie_id: 11, actor_id: 99}
|> Repo.insert!()

%Character{protagonist: false, character: "Missus Walters", movie_id: 11, actor_id: 100}
|> Repo.insert!()

%Character{protagonist: false, character: "Robert Phelan", movie_id: 11, actor_id: 101}
|> Repo.insert!()

# Back to the Future
%Character{protagonist: true, character: "Marty McFly", movie_id: 12, actor_id: 102}
|> Repo.insert!()

%Character{protagonist: true, character: "Dr. Emmett Brown", movie_id: 12, actor_id: 103}
|> Repo.insert!()

%Character{protagonist: false, character: "Lorraine Baines", movie_id: 12, actor_id: 104}
|> Repo.insert!()

%Character{protagonist: false, character: "George McFly", movie_id: 12, actor_id: 105}
|> Repo.insert!()

%Character{protagonist: false, character: "Biff Tannen", movie_id: 12, actor_id: 106}
|> Repo.insert!()

%Character{protagonist: false, character: "Jennifer Parker", movie_id: 12, actor_id: 107}
|> Repo.insert!()

%Character{protagonist: false, character: "Dave McFly", movie_id: 12, actor_id: 108}
|> Repo.insert!()

%Character{protagonist: false, character: "Linda McFly", movie_id: 12, actor_id: 109}
|> Repo.insert!()

%Character{protagonist: false, character: "Sam Baines", movie_id: 12, actor_id: 110}
|> Repo.insert!()

%Character{protagonist: false, character: "Stella Baines", movie_id: 12, actor_id: 111}
|> Repo.insert!()

%Character{protagonist: false, character: "Mr. Strickland", movie_id: 12, actor_id: 112}
|> Repo.insert!()

%Character{protagonist: false, character: "Skinhead", movie_id: 12, actor_id: 113}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Marvin Berry", movie_id: 12, actor_id: 116}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Pretty Girl", movie_id: 13, actor_id: 125}
|> Repo.insert!()

%Character{protagonist: false, character: "Schoolboy ", movie_id: 13, actor_id: 126}
|> Repo.insert!()

%Character{protagonist: false, character: "Science Teacher", movie_id: 13, actor_id: 127}
|> Repo.insert!()

%Character{protagonist: false, character: "Policeman", movie_id: 13, actor_id: 128}
|> Repo.insert!()

%Character{protagonist: false, character: "Ultra Sound Man", movie_id: 13, actor_id: 129}
|> Repo.insert!()

%Character{protagonist: false, character: "Van Man", movie_id: 13, actor_id: 130}
|> Repo.insert!()

%Character{protagonist: false, character: "Medical Unit ", movie_id: 13, actor_id: 131}
|> Repo.insert!()

# The Lord of the Rings: The Fellowship of the Ring
%Character{protagonist: true, character: "Voice of the Ring", movie_id: 14, actor_id: 132}
|> Repo.insert!()

%Character{protagonist: true, character: "Everard Proudfoot", movie_id: 14, actor_id: 133}
|> Repo.insert!()
...
%Character{protagonist: true, character: "Galadriel", movie_id: 14, actor_id: 137}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Celeborn", movie_id: 14, actor_id: 140}
|> Repo.insert!()

%Character{protagonist: false, character: "Mrs. Proudfoot", movie_id: 14, actor_id: 141}
|> Repo.insert!()

%Character{protagonist: false, character: "Gondorian Archivist", movie_id: 14, actor_id: 142}
|> Repo.insert!()

%Character{protagonist: false, character: "Gil-galad", movie_id: 14, actor_id: 143}
|> Repo.insert!()

%Character{protagonist: false, character: "Bilbo", movie_id: 14, actor_id: 144} |> Repo.insert!()

%Character{protagonist: false, character: "Saruman", movie_id: 14, actor_id: 145}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Dr. King Schultz", movie_id: 15, actor_id: 148}
|> Repo.insert!()

%Character{protagonist: false, character: "Calvin Candie", movie_id: 15, actor_id: 9}
|> Repo.insert!()

%Character{protagonist: false, character: "Broomhilda von Shaft", movie_id: 15, actor_id: 149}
|> Repo.insert!()

%Character{protagonist: false, character: "Stephen", movie_id: 15, actor_id: 150}
|> Repo.insert!()

%Character{protagonist: false, character: "Billy Crash", movie_id: 15, actor_id: 151}
|> Repo.insert!()

%Character{protagonist: false, character: "Leonide Moguy", movie_id: 15, actor_id: 152}
|> Repo.insert!()

%Character{protagonist: false, character: "Butch Pooch", movie_id: 15, actor_id: 153}
|> Repo.insert!()

%Character{protagonist: false, character: "Mr. Stonesipher", movie_id: 15, actor_id: 154}
|> Repo.insert!()
...
%Character{protagonist: false, character: "D'Artagnan", movie_id: 15, actor_id: 158}
|> Repo.insert!()

%Character{protagonist: false, character: "Rodney", movie_id: 15, actor_id: 159} |> Repo.insert!()

%Character{protagonist: false, character: "Big Fred's Opponent", movie_id: 15, actor_id: 160}
|> Repo.insert!()

# Cars
%Character{protagonist: true, character: "Lightning McQueen", movie_id: 16, actor_id: 161}
|> Repo.insert!()

%Character{protagonist: false, character: "Doc Hudson", movie_id: 16, actor_id: 162}
|> Repo.insert!()

%Character{protagonist: false, character: "Sally Carrera", movie_id: 16, actor_id: 163}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Sheriff", movie_id: 16, actor_id: 170}
|> Repo.insert!()

%Character{protagonist: false, character: "Fillmore", movie_id: 16, actor_id: 171}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Chick Hicks", movie_id: 16, actor_id: 175}
|> Repo.insert!()

# Cars 2
%Character{protagonist: true, character: "Lightning McQueen", movie_id: 17, actor_id: 161}
|> Repo.insert!()

%Character{protagonist: false, character: "Mater", movie_id: 17, actor_id: 164} |> Repo.insert!()

%Character{protagonist: false, character: "Finn McMissile", movie_id: 17, actor_id: 75}
|> Repo.insert!()

%Character{protagonist: false, character: "Holley Shiftwell", movie_id: 17, actor_id: 176}
|> Repo.insert!()

%Character{protagonist: false, character: "Sir Miles Axlerod", movie_id: 17, actor_id: 177}
|> Repo.insert!()

%Character{protagonist: false, character: "Francesco Bernoulli", movie_id: 17, actor_id: 178}
|> Repo.insert!()

%Character{protagonist: false, character: "Brent Mustangburger ", movie_id: 17, actor_id: 179}
|> Repo.insert!()

%Character{protagonist: false, character: "Grem", movie_id: 17, actor_id: 180} |> Repo.insert!()

%Character{protagonist: false, character: "Professor Z", movie_id: 17, actor_id: 181}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Darrell Cartrip ", movie_id: 17, actor_id: 183}
|> Repo.insert!()

%Character{protagonist: false, character: "Uncle Topolino", movie_id: 17, actor_id: 184}
|> Repo.insert!()

%Character{protagonist: false, character: "David Hobbscap ", movie_id: 17, actor_id: 185}
|> Repo.insert!()

%Character{protagonist: false, character: "Mel Dorado ", movie_id: 17, actor_id: 186}
|> Repo.insert!()

# Cars 3
%Character{protagonist: true, character: "Lightning McQueen", movie_id: 18, actor_id: 187}
|> Repo.insert!()

%Character{protagonist: false, character: "Cruz Ramirez", movie_id: 18, actor_id: 188}
|> Repo.insert!()

%Character{protagonist: false, character: "Smokey", movie_id: 18, actor_id: 189} |> Repo.insert!()

%Character{protagonist: false, character: "Sterling", movie_id: 18, actor_id: 190}
|> Repo.insert!()

%Character{protagonist: false, character: "Mater", movie_id: 18, actor_id: 191} |> Repo.insert!()

%Character{protagonist: false, character: "Jackson Storm", movie_id: 18, actor_id: 192}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Miss Fritter", movie_id: 18, actor_id: 196}
|> Repo.insert!()

%Character{protagonist: false, character: "Natalie Certain", movie_id: 18, actor_id: 197}
|> Repo.insert!()

%Character{protagonist: false, character: "Bob Cutlass", movie_id: 18, actor_id: 198}
|> Repo.insert!()

%Character{protagonist: false, character: "Louise Nash", movie_id: 18, actor_id: 199}
|> Repo.insert!()

%Character{protagonist: false, character: "Darrell Cartrip", movie_id: 18, actor_id: 200}
|> Repo.insert!()

%Character{protagonist: false, character: "River Scott", movie_id: 18, actor_id: 201}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Kristoff", movie_id: 19, actor_id: 204}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Bishop ", movie_id: 19, actor_id: 213}
|> Repo.insert!()

%Character{protagonist: false, character: "King", movie_id: 19, actor_id: 214} |> Repo.insert!()

%Character{protagonist: false, character: "Young Anna", movie_id: 19, actor_id: 215}
|> Repo.insert!()

%Character{protagonist: false, character: "Young Elsa", movie_id: 19, actor_id: 216}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Captain", movie_id: 20, actor_id: 219}
|> Repo.insert!()

%Character{protagonist: false, character: "Shelby Forthright", movie_id: 20, actor_id: 220}
|> Repo.insert!()
...
%Character{protagonist: false, character: "Ship's Computer", movie_id: 20, actor_id: 224}
|> Repo.insert!()

%Character{protagonist: false, character: "Steward Bots", movie_id: 20, actor_id: 225}
|> Repo.insert!()

%Character{protagonist: false, character: "Forthright's Advisor ", movie_id: 20, actor_id: 226}
|> Repo.insert!()

%Character{protagonist: false, character: "Axiom Passenger #3 ", movie_id: 20, actor_id: 227}
|> Repo.insert!()

%Character{protagonist: false, character: "Lifeguard Bot ", movie_id: 20, actor_id: 228}
|> Repo.insert!()

%Character{protagonist: false, character: "Axiom Passenger #12 ", movie_id: 20, actor_id: 229}
|> Repo.insert!()

%Character{protagonist: false, character: "Axiom Passenger #7 ", movie_id: 20, actor_id: 230}
|> Repo.insert!()

%Character{protagonist: false, character: "(voice)", movie_id: 20, actor_id: 231}
|> Repo.insert!()
...
Repo.insert_all("movies_genres", [
  %{movie_id: 16, genre_id: 11},
  %{movie_id: 16, genre_id: 13},
...
Repo.insert_all("movies_genres", [
  ...
  %{movie_id: 17, genre_id: 11},
  %{movie_id: 17, genre_id: 13},
  %{movie_id: 17, genre_id: 14}
])

Repo.insert_all("movies_genres", [
  %{movie_id: 18, genre_id: 5},
  %{movie_id: 18, genre_id: 10},
  %{movie_id: 18, genre_id: 11},
  %{movie_id: 18, genre_id: 13},
  %{movie_id: 18, genre_id: 14}
])

Repo.insert_all("movies_genres", [
  %{movie_id: 19, genre_id: 5},
  %{movie_id: 19, genre_id: 6},
  %{movie_id: 19, genre_id: 10},
  %{movie_id: 19, genre_id: 11},
  %{movie_id: 19, genre_id: 13},
  %{movie_id: 19, genre_id: 15}
])

Repo.insert_all("movies_genres", [
  %{movie_id: 20, genre_id: 2},
  %{movie_id: 20, genre_id: 5},
  %{movie_id: 20, genre_id: 11},
  %{movie_id: 20, genre_id: 13}
])
...
Repo.insert_all("movies_languages", [
  %{movie_id: 2, language_id: 1},
  %{movie_id: 2, language_id: 5},
  %{movie_id: 2, language_id: 6}
])

Repo.insert_all("movies_languages", [
  %{movie_id: 3, language_id: 1},
  %{movie_id: 3, language_id: 4}
])
...
Repo.insert_all("movies_languages", [
  %{movie_id: 8, language_id: 1},
  %{movie_id: 8, language_id: 6},
  %{movie_id: 8, language_id: 7}
])

Repo.insert_all("movies_languages", [
  %{movie_id: 9, language_id: 1},
  %{movie_id: 9, language_id: 4}
])

Repo.insert_all("movies_languages", [
  %{movie_id: 10, language_id: 1},
  %{movie_id: 10, language_id: 8}
])
...
Repo.insert_all("movies_languages", [
  %{movie_id: 14, language_id: 1},
  %{movie_id: 14, language_id: 9}
])

Repo.insert_all("movies_languages", [
  %{movie_id: 15, language_id: 1},
  %{movie_id: 15, language_id: 4},
  %{movie_id: 15, language_id: 6},
  %{movie_id: 15, language_id: 10}
])

Repo.insert_all("movies_languages", [
  %{movie_id: 16, language_id: 1},
  %{movie_id: 16, language_id: 6},
  %{movie_id: 16, language_id: 11},
  %{movie_id: 16, language_id: 12}
])

Repo.insert_all("movies_languages", [
  %{movie_id: 17, language_id: 1},
  %{movie_id: 17, language_id: 4},
  %{movie_id: 17, language_id: 6},
  %{movie_id: 17, language_id: 11}
])

Repo.insert_all("movies_languages", [%{movie_id: 18, language_id: 1}])

Repo.insert_all("movies_languages", [
  %{movie_id: 19, language_id: 1},
  %{movie_id: 19, language_id: 13}
])
...
## i##
Repo.insert_all("movies_directors", [
...
Repo.insert_all("movies_directors", [
  %{movie_id: 16, director_id: 16},
  %{movie_id: 16, director_id: 17}
])

Repo.insert_all("movies_directors", [
  %{movie_id: 17, director_id: 16},
  %{movie_id: 17, director_id: 18}
])

Repo.insert_all("movies_directors", [%{movie_id: 18, director_id: 19}])

Repo.insert_all("movies_directors", [
  %{movie_id: 19, director_id: 20},
  %{movie_id: 19, director_id: 21}
])
...
Repo.insert_all("movies_writers", [
  %{movie_id: 5, writer_id: 4},
  %{movie_id: 5, writer_id: 5},
  %{movie_id: 5, writer_id: 6}
])

Repo.insert_all("movies_writers", [%{movie_id: 6, writer_id: 4}, %{movie_id: 6, writer_id: 6}])

Repo.insert_all("movies_writers", [
  %{movie_id: 7, writer_id: 7},
  %{movie_id: 7, writer_id: 8},
  %{movie_id: 7, writer_id: 9}
])
...
Repo.insert_all("movies_writers", [
  %{movie_id: 10, writer_id: 14},
  %{movie_id: 10, writer_id: 15},
  %{movie_id: 10, writer_id: 16},
  %{movie_id: 10, writer_id: 17}
])
...
Repo.insert_all("movies_writers", [
  %{movie_id: 14, writer_id: 23},
  %{movie_id: 14, writer_id: 24},
  %{movie_id: 14, writer_id: 25},
  %{movie_id: 14, writer_id: 26}
])

Repo.insert_all("movies_writers", [%{movie_id: 15, writer_id: 27}])

Repo.insert_all("movies_writers", [
  %{movie_id: 16, writer_id: 28},
  %{movie_id: 16, writer_id: 29},
  %{movie_id: 16, writer_id: 30},
  %{movie_id: 16, writer_id: 31},
  %{movie_id: 16, writer_id: 32},
  %{movie_id: 16, writer_id: 33},
  %{movie_id: 16, writer_id: 34}
])

Repo.insert_all("movies_writers", [
  %{movie_id: 17, writer_id: 28},
  %{movie_id: 17, writer_id: 31},
  %{movie_id: 17, writer_id: 35},
  %{movie_id: 17, writer_id: 36}
])

Repo.insert_all("movies_writers", [
  %{movie_id: 18, writer_id: 37},
  %{movie_id: 18, writer_id: 38},
  %{movie_id: 18, writer_id: 39},
  %{movie_id: 18, writer_id: 40},
  %{movie_id: 18, writer_id: 41},
  %{movie_id: 18, writer_id: 42},
  %{movie_id: 18, writer_id: 43},
  %{movie_id: 18, writer_id: 44}
])

Repo.insert_all("movies_writers", [
  %{movie_id: 19, writer_id: 45},
  %{movie_id: 19, writer_id: 46},
  %{movie_id: 19, writer_id: 47},
  %{movie_id: 19, writer_id: 48},
  %{movie_id: 19, writer_id: 49}
])

Repo.insert_all("movies_writers", [
  %{movie_id: 20, writer_id: 50},
  %{movie_id: 20, writer_id: 51},
  %{movie_id: 20, writer_id: 52}
])
...
## i##
Repo.insert_all("movies_companies", [
  %{movie_id: 1, company_id: 1},
  %{movie_id: 1, company_id: 2},
  %{movie_id: 1, company_id: 3}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 2, company_id: 4},
  %{movie_id: 2, company_id: 5},
  %{movie_id: 2, company_id: 6}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 3, company_id: 1},
  %{movie_id: 3, company_id: 2},
  %{movie_id: 3, company_id: 3}
])
...
Repo.insert_all("movies_companies", [
  ...
  %{movie_id: 10, company_id: 10},
  %{movie_id: 10, company_id: 11},
  %{movie_id: 10, company_id: 12}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 11, company_id: 13},
  %{movie_id: 11, company_id: 14}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 12, company_id: 15},
  %{movie_id: 12, company_id: 16}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 13, company_id: 15},
  %{movie_id: 13, company_id: 16}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 14, company_id: 17},
  %{movie_id: 14, company_id: 18}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 15, company_id: 19},
  %{movie_id: 15, company_id: 20}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 16, company_id: 21},
  %{movie_id: 16, company_id: 22}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 17, company_id: 21},
  %{movie_id: 17, company_id: 22}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 18, company_id: 21},
  %{movie_id: 18, company_id: 22}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 19, company_id: 21},
  %{movie_id: 19, company_id: 23}
])

Repo.insert_all("movies_companies", [
  %{movie_id: 20, company_id: 21},
  %{movie_id: 20, company_id: 22}
])
