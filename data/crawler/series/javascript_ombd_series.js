...
$i = 6;
$genres = "    <genre>" + document.evaluate("//html/body/div/div/div/div[1]/div/div/div[2]/table/tbody/tr[" + $i + "]/td[2]/span/span//text()",
	document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.textContent.trim().replace(/\"/g, "")
	.replace(/, /g, "</genre>\n    <genre>") + "</genre>\n";

$i = 8;
$writers = "    <writer>" + document.evaluate("//html/body/div/div/div/div[1]/div/div/div[2]/table/tbody/tr[" + $i + "]/td[2]/span/span//text()",
	document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.textContent.trim().replace(/\"/g, "")
	.replace(/, /g, "</writer>\n    <writer>") + "</writer>\n";
...
$i = 11;
$languages = "    <language>" + document.evaluate("//html/body/div/div/div/div[1]/div/div/div[2]/table/tbody/tr[" + $i + "]/td[2]/span/span//text()",
	document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.textContent.trim().replace(/\"/g, "")
	.replace(/, /g, "</language>\n    <language>") + "</language>\n";

$i = 12;
$countries = "    <country>" + document.evaluate("//html/body/div/div/div/div[1]/div/div/div[2]/table/tbody/tr[" + $i + "]/td[2]/span/span//text()",
	document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.textContent.trim().replace(/\"/g, "")
	.replace(/, /g, "</country>\n    <country>") + "</country>\n";
